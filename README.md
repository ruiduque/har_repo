...
- 'UCI HAR Dataset'       Folder containing the original dataset files

- 'run_analysis.R'        Main script containing the code to perform the 5 points analysis described above.
...
### Files used from the "UCI HAR Dataset":
